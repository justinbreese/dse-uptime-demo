...
export function writeApi() {
    ...
    return(dispatch, getState) => {
        ...
        const url = 'http://52.15.206.216:8080/demo/write';
        streamingRequest({
            url: url,
            params: data,
...
export function readApi() {
    ...
    return(dispatch, getState) => {
        ...
        const url = 'http://52.15.206.216:8080/demo/read';
        streamingRequest({
            url: url,
            params: data,
            success: function(response){
...
export function dropOneNode() {
    return(dispatch, getState) => {
        ...
        const url = 'http://52.15.206.216:8080/demo/killnode';
...
export function dropOneDataCenter() {
    ...
    return(dispatch, getState) => {
        ...
        const url = 'http://52.15.206.216:8080/demo/chaos';
...
export function resetAllNodes() {
    return(dispatch, getState) => {
        ...
        const url = 'http://52.15.206.216:8080/demo/recover';
        const nodesDown = [];
